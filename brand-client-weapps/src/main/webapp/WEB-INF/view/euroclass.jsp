...
<body>
	<input type="hidden" id="currentNavId" value="euroclass">
				...
				<div class="">
					<ul class="breadcrumb">
						...
						<c:if test="${not empty largeType and empty smallType}">
							<li><a href="${ctxPath}/euroclass.html" class="pathway">欧盟商品与服务项目</a></li>
							<li class="active"><span>${largeType.name}</span></li>
						</c:if>
						<c:if test="${not empty smallType and not empty largeType}">
							<li><a href="${ctxPath}/euroclass.html" class="pathway">欧盟商品与服务项目</a></li>
							<li><a href="${ctxPath}/euroclass/class${largeType.id}.html" class="pathway">${largeType.name}</a></li>
					...
					<div class="cbListView">
						<form action="" method="post" name="adminForm" id="adminForm"
							...
							<div id="cbSearchButtonWrap"
								...
								<button class="button btn btn-secondary cbButton cbSearchButton"
									onclick="getCookieList('euroclass');" data-toggle="modal" data-target="#cookieList">获取标记值</button>
							</div>
						...
						<script type="text/javascript">
							...
							function setEuroClassCookie(obj,id,name){
								if($(obj).is(':checked')){
									$.ajax({ 
										url: "${ctxPath}/setEuroClassCookie",
										type: 'POST',
									...
									$.ajax({ 
										url: "${ctxPath}/cancelEuroClassCookie/"+id,
										type: 'POST',
										success: function(){
								    	}
									});
											...
											<div class="panel-heading">
												<h4>
													<span style="font-size: 16pt;"><a
														href="${ctxPath}/euroclass.html" target="_self">欧盟《商品与服务区分表》</a>目录</span>
												</h4>
											</div>
														...
														<c:forEach items="${largeTypeList}" var="item">
															<label style="width:28px;text-align: center;">
																<span style="font-family: arial black,avant garde; font-size: 12pt;">
																	<span style="font-family: arial black,avant garde; font-size: 12pt;">
																		<a href="${ctxPath}/euroclass/class${item.id}/">${item.catalog}</a>
																	</span>
																</span>
															</label>
														</c:forEach>
											...
											<div class="panel-heading">
												<h4 class="panel-title" style="text-align: left;">
													...
													<span style="color: #21c2f8; font-size: 10pt;"> 
														<a href="${ctxPath}/euroclass/class${item.id}/" target="_self"> 
